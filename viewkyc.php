                                        ...
                                        <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="form-controls">
                                                    <a href="updatekyc.php?id=<?php echo $row["id"] ?>"  target="_blank" class="btn waves-effect waves-light green col s3 offset-s9"><i class="material-icons right">save</i>Append Record</a>                                        
                                                </div>
                                            </div>
                                            </form>
                                            </div>
